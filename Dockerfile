FROM squidfunk/mkdocs-material:5.5.0 as material
...
RUN apt-get remove --purge -y binutils git perl patch openssl bzip2 procps tar systemd --allow-remove-essential && \
